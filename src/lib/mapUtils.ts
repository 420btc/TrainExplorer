...
export const MAP_SIZE_CONFIGS: Record<MapSize, MapSizeConfig> = {
  [MapSize.SMALL]: {
    ...
    minStationDistance: 0.2  // Mucho más pequeño (era 0.2)
  },
  [MapSize.MEDIUM]: {
